class SpriteClass implements Sprite {
    ...
    constructor(height: number, width: number, name: string, image: string, idleFrames: number, walkFrames: number, actionFrames: number, currentFrame: number, framesElapsed: number, framesHold: number, direction: number) {
        this.height = height;
        this.width = width;
        this.name = name;
        this.image = image;
